...
public class ZttClient extends BaseEntity implements Serializable{
	...
	private String operation_status;/**客户经营状况**/
	private String type;/**类型**/
	private String is_connect;/**是否联系：1-是，0-否**/
	private int yc_num;/**已验厂次数**/
	private String yc_status;/**状态：1-正常，0-删除**/
	...
	private String judge_grade;/**再评审等级：0-无，1-I级考核标准，2-Ⅱ级考核标准,3-Ⅲ级考核标准，4-不合格，直接淘汰**/
