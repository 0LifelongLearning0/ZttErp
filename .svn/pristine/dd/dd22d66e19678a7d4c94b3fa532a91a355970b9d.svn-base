		...
		<fieldset>
			...
			<div id="myTabContent" class="tab-content">
				<div class="tab-pane fade in active" id="tab0">
					<font color=red>权限最高</font><br>使用说明:<br>如设置人员为"",即被选择人员为,邓益帝。这种含义指拥有",邓益帝"权限。比如可设置拥有数据的编辑，删除功能功能，拥有读取邓益帝数据权限<br>以上功能可完成业务为:比如一个公司销售员录入自己的客户,但是自己不能修改自己客户,只能由销售经理修改,但销售经理录入的客户自己不能修改,只能由销售主管来修改同比类推,该权限可以精确到针对每一个人员进行设置
				</div>
