							...
							.pagingOptions({
								ajax : function(data, callback, settings) {
									datatablesCallBack(
											...
											callback,
											settings,
											'../zttOrderController/getZttOrderfilehistory',
											opt);
								},// 渲染数据
								// 在第一位置追加序列号
								...
								colums : [
										...
										}*/
										{
											...
											render : function(data, type, row,
													meta) {
												return "<a href=\"javascript:downloadattachment('"+data +"')\"><span class='glyphicon glyphicon-arrow-down' title='下载'></span></a>&emsp;";
											}
...
function downloadattachment(attachment) {
	...
	layer.open({
		...
		area : [ '500px', '500px' ],
		btn : [ '关闭'],
		content : "../zttOrderController/DownloadHisattachment?attachment=" + attachment+"&type="+file
