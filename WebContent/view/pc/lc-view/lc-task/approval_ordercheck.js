...
$(document).ready(function(){
	...
	document.getElementById("selfchecker_attachment").value=ajaxobj.checker_attachment;
});
...
function approveZttOrderApply(taskid,status,obj){
	...
	var params = {task_id:taskid,task_status:status,remark:remark,path:path,checkcomment:checkcomment};
	$.ajax({ 
		   url: url, 
		   async:false, 
           type:'POST',
