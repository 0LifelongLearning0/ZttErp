						...
						<table class="table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td colspan="2"><input id="erp_number"/></td>
								</tr>
							</tbody>
						</table>
						<div class="col-lg-6" style="text-align:center">
							<button type="button" class="btn btn-success"
								onclick='approveZttOrderApply(${taskData.task.id },"erp",this)'>
...
<script type="text/javascript"
	src="../view/pc/lc-view/lc-task/approval_orderApplyData.js"></script>
