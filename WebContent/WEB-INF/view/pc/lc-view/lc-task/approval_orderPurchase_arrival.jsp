				...
				<div class="row">
					<form class="form-horizontal" id="defaultForm" method="post">
						<table class="table table-bordered">
							<caption class="text-center h3 no-margin bold">发起采购</caption>
							<tbody>
								<tr>
						...
						<div class="col-lg-6" style="text-align: center">
							<button type="button" class="btn btn-primary"
								...
								<span class="glyphicon glyphicon-saved" aria-hidden="true"></span>发起采购
							</button>
						</div>
					</form>
				</div>
...
<script type="text/javascript"
	src="../view/pc/lc-view/lc-task/approval_orderPurchase_arrival.js"></script>
<script type="text/javascript"
