					...
					<form class="form-horizontal" id="defaultForm" method="post">
							...
							<tbody>
								...
								<td class="text-center">数量</td>
									...
									<td colspan="2"><button class="btn btn-primary"
										...
										name="delivery_note" id="delivery_note"></td>
								</tr>
							</tbody>
						</table>
						<div class="col-lg-6" style="text-align: center">
							<button type="button" class="btn btn-warning"
								...
								<span class="glyphicon glyphicon-refresh" aria-hidden="true"></span>确认到货
							</button>
						</div>
					</form>
				</div>
...
<script type="text/javascript"
	src="../view/pc/lc-view/lc-task/approval_orderApplybuywarehouse_dept.js"></script>
<script type="text/javascript"
