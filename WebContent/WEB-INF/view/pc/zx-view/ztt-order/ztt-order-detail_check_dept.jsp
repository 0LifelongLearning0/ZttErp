					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="2" id="checkreport1"><button
										class="btn btn-primary" data-toggle="button"
										onclick="downloadattachmentcheck('${zttOrder.id}')">查看</button>
									<input class="form-control" type="hidden" maxlength="255"
									name="checker_attachment" id="checker_attachment" value='${zttOrder.checker_attachment }'></td>
								<td class="text-center">质检部检验报告</td>
								<td colspan="2"><button class="btn btn-primary"
										data-toggle="button" onclick="downloadattachmentcheckdept()">查看</button>
									<input class="form-control" type="hidden" maxlength="255"
									name="dept_check_attachment" id="dept_check_attachment" value='${zttOrder.dept_check_attachment }'>
								</td>
							</tr>
						</tbody>
					</table>
...
<script type="text/javascript"
	src="../view/pc/zx-view/ztt-order/ztt-order-detail_check_dept.js"></script>
</html>
