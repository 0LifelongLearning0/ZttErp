...
<body>
	<div class="panel panel-default padding-10 no-margin">
			...
			<div class="container-fluid">
				<div class="row col-md-8 col-md-offset-2">
					...
					<input class="form-control" type="hidden" maxlength="32" id="state" name="state" value="0">
					</div>
	...
	<script type="text/javascript"
		src="../view/pc/zx-view/ztt-order/processingtechselfprocheckhistory.js"></script>
</html>
