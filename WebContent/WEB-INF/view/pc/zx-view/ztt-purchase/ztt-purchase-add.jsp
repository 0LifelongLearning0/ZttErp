	...
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="255"  name="purchase_name" placeholder="请输入名称">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">规格</label>
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="32"  name="purchase_stardard" placeholder="请输入规格">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">材质</label>
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="32"  name="material" placeholder="请输入材质">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">单位</label>
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="32"  name="unit" placeholder="请输入单位">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">数量</label>
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="20"  name="amount" placeholder="请输入数量">
				</div>
			</div>
			<div class="form-group">
