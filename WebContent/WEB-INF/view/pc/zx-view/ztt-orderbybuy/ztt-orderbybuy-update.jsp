	...
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<button type="button" class="btn green" onclick="updateZttOrderbybuy()">保存</button>
...
<script type="text/javascript" src="../view/pc/zx-view/ztt-orderbybuy/ztt-orderbybuy-update.js"></script> 
</html>
